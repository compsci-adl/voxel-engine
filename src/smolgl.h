...
#include <stdio.h>
    ...
    #define SMOLGL_DEFAULT_SHADER_ATTRIB_NAME_POSITION     "vertexPosition"    // Bound by default to shader location: SMOLGL_DEFAULT_SHADER_ATTRIB_NAME_POSITION
#endif
...
unsigned int smolLoadVertexBufferElement(const void *buffer, int size, bool dynamic)
{
    unsigned int id = 0;
